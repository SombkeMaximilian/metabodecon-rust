...
//! deconvolution results Functionality for reading data from the Bruker
//! TopSpin, JCAMP-DX, and HDF5 formats An implementation of the automated
//! feature extraction algorithm for the deconvolution of 1D NMR spectra
//! described in [Koh et al. (2009)] An implementation of the alignment
//! algorithm described in [Vu et al. (2011)] and [Beirnaert et al. (2018)]
//!
